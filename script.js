...
function updateLocalStorage() {
  ...
  localStorage.setItem('currentSkin', currentSkin); // Сохраняем текущий скин
}
...
// Админ панель и управление балансом
let isAdmin = false;
...
function openSkinsShop() {
    ...
    document.body.innerHTML = `
      ...
      <div class="menu">
        ...
        <div class="item" id="item-default">
          <img src="https://i.postimg.cc/ns1FhD4q/corgi-image.jpg" alt="Фото" class="item-image">
          <div class="item-info">
            <div class="coin">
        ...
        <div class="item" id="item-skin1">
          <img src="https://i.postimg.cc/YCP0Xn7N/skin1.png" alt="Фото" class="item-image">
          <div class="item-info">
            <div class="coin">
        ...
        <div class="item" id="item-skin2">
          <img src="https://i.postimg.cc/YCP0Xn7N/skin2.png" alt="Фото" class="item-image">
          <div class="item-info">
            <div class="coin">
        ...
        <div class="item" id="item-skin3">
          <img src="https://i.postimg.cc/YCP0Xn7N/skin3.png" alt="Фото" class="item-image">
          <div class="item-info">
            <div class="coin">
        ...
        <div class="item" id="item-skin4">
          <img src="https://i.postimg.cc/YCP0Xn7N/skin4.png" alt="Фото" class="item-image">
          <div class="item-info">
            <div class="coin">
        ...
        <div class="item" id="item-skin5">
          <img src="https://i.postimg.cc/YCP0Xn7N/skin5.png" alt="Фото" class="item-image">
          <div class="item-info">
            <div class="coin">
  ...
  function wearSkin(skinName) {
    document.getElementById('corgi').src = getSkinImage(skinName); // Меняем изображение корги
    currentSkin = skinName;
    localStorage.setItem('currentSkin', skinName); // Сохраняем текущий скин
    displayMessage(`${skinName} одет!`);
    openSkinsShop(); // Обновляем магазин для синхронизации
  }
  
  function getSkinImage(skinName) {
    switch(skinName) {
      case 'skin1': return 'https://i.postimg.cc/YCP0Xn7N/skin1-corgi.png'; // URL для скина 1
      case 'skin2': return 'https://i.postimg.cc/YCP0Xn7N/skin2-corgi.png'; // URL для скина 2
      case 'skin3': return 'https://i.postimg.cc/YCP0Xn7N/skin3-corgi.png'; // URL для скина 3
      case 'skin4': return 'https://i.postimg.cc/YCP0Xn7N/skin4-corgi.png'; // URL для скина 4
      case 'skin5': return 'https://i.postimg.cc/YCP0Xn7N/skin5-corgi.png'; // URL для скина 5
      default: return 'https://i.postimg.cc/ns1FhD4q/corgi-image.jpg'; // Стандартный скин
    }
  }
...
function getSkinImage(skinName) {
  switch(skinName) {
    case 'skin1': return 'https://i.postimg.cc/YCP0Xn7N/skin1-corgi.png'; // URL изображения для первого скина
    case 'skin2': return 'https://i.postimg.cc/YCP0Xn7N/skin2-corgi.png'; // URL изображения для второго скина
    default: return 'https://i.postimg.cc/ns1FhD4q/corgi-image.jpg'; // URL стандартного изображения корги
  }
}
